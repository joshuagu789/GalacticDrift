...
// void UClass_RacingGameInstance::BeginPlay(){
// 	Super::BeginPlay();
// }
...
// void UClass_RacingGameInstance::BeginGame(){
//     GEngine->AddOnScreenDebugMessage(-1, 15.0f, FColor::Yellow, TEXT("beginning game in racing game instance"));
// }